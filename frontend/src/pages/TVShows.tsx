  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#0A1D37] via-[#0F2438] to-[#0B1C2C] text-white py-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h1 className="text-4xl font-bold text-center mb-4">TV Shows</h1>
          <p className="text-xl text-gray-300 text-center mb-12">
            Discover our collection of TV series and shows
          </p>
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <p className="text-gray-400 mb-4">
                    A brief description of the TV show and its episodes.
                  </p>
                  <div className="flex justify-between items-center">
                    <span className="text-orange-400 font-medium">5 Seasons</span>
