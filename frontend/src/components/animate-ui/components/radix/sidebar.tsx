    ...
    return (
      ...
      >
        <div
          data-slot="sidebar"
          className={cn(
            'bg-[#0A1D37] text-white flex h-full w-(--sidebar-width) flex-col',
            className
          )}
          {...props}
        >
    ...
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        <SheetContent
          ...
          data-slot="sidebar"
          data-mobile="true"
          className="bg-[#0A1D37] text-white w-(--sidebar-width) p-0 [&>button]:hidden"
          style={
            {
        ...
        >
          ...
          <Highlight
            ...
            transition={transition}
          >
            <div className="bg-[#0A1D37] flex h-full w-full flex-col">{children}</div>
          </Highlight>
        </SheetContent>
      </Sheet>
    );
      ...
      >
        ...
        >
          <div
            ...
            className="bg-[#0A1D37] group-data-[variant=floating]:border-gray-400 flex h-full w-full flex-col group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:shadow-sm"
          >
            {children}
          </div>
        </Highlight>
